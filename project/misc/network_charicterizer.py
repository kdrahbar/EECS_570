...
def bandwidth_plot(input_file):
    ...
    fig.suptitle('Bandwidth vs. Filesize on EC2', fontsize=13)
...
if __name__ == "__main__":
    ...
    bandwidth_plot("/Users/kdrahbar/workspaces/EECS_570/project/tests/max_bandwidth/same_location/client_timings.txt")
